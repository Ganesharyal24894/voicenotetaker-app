      ...
      children: <Widget>[
        ...
        _SquareButton(
          ...
          child: const CustomPaint(
            size: Size.square(18),
            painter: _CopyGlyphPainter(color: AppColors.textSecondary),
          ),
        ),
        if (_canPlay) ...<Widget>[
          const SizedBox(width: 10),
...
/// Two overlapping rounded squares - the design's copy glyph, in the same
/// 24x24 box and stroke as `AppIcon`.
class _CopyGlyphPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // M15.5 8.5V6a2.5 2.5 0 0 0-2.5-2.5H6A2.5 2.5 0 0 0 3.5 6v7
    // A2.5 2.5 0 0 0 6 15.5h2.5
    canvas.drawPath(
      Path()
        ..moveTo(15.5, 8.5)
        ..lineTo(15.5, 6)
        ..arcToPoint(const Offset(13, 3.5),
            radius: const Radius.circular(2.5), clockwise: false)
        ..lineTo(6, 3.5)
        ..arcToPoint(const Offset(3.5, 6),
            radius: const Radius.circular(2.5), clockwise: false)
        ..lineTo(3.5, 13)
        ..arcToPoint(const Offset(6, 15.5),
            radius: const Radius.circular(2.5), clockwise: false)
        ..lineTo(8.5, 15.5),
      stroke,
    );
